...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.requestMarkedExam":
		...
		return e.complexity.Mutation.RequestMarkedExam(childComplexity, args["UUID"].(string)), true
...
func (ec *executionContext) _Mutation_requestMarkedExam(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().RequestMarkedExam(rctx, args["UUID"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
